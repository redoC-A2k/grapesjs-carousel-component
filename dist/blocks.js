...
exports.default = (editor, opts) => {
    ...
    bm.add(consts_1.carousel.name, {
        label: consts_1.carousel.label,
        ...
        category: 'Carousel',
        content: { type: consts_1.carousel.type }
    });
    bm.add(consts_1.slide.name, {
        label: consts_1.slide.label,
        category: "Carousel",
        ...
        content: { type: consts_1.slide.type }
    });
};
//     content: `
//     <div
